package com.tinydavid.djiwaypointmission.ui.camera
...
class CameraActivity : AppCompatActivity(), TextureView.SurfaceTextureListener,
    ...
    private fun initPreviewer() {
        ...
        val product: BaseProduct = DJIApplication.getProductInstance() ?: return
    ...
    private fun startRecord() {
        val camera = DJIApplication.getCameraInstance()
            ?: return //get camera instance or null if it doesn't exist
